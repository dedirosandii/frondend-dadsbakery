package com.skiddie.dadsbakery.ui.home.recommended
...
//        initDataDummy()
        val adapter = recommendedList?.let { HomeNewtasteAdapter(it, this) }
...
//        foodList.add(HomeVerticalModel("Goreng", "20000","",4.5f))
//    }
